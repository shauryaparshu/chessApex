  ...
  return (
    <>
      ...
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Elevate Your Chess Game with Expert Coaching
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  Join ChessApex to learn, improve, and master chess from the
                  best. Whether you’re a beginner eager to learn the basics or
                  an experienced player aiming to refine your strategies, our
                  expert coach is here to guide you every step of the way.
                </p>
        ...
        {/* Updated SVG backgrounds with new primary color */}
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.145833" stopColor="#FF520E" stopOpacity="0" />
                <stop offset="1" stopColor="#FF520E" stopOpacity="0.08" />
              </radialGradient>
              <radialGradient
                id="paint2_radial"
                cx="0"
        ...
        <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
          ...
          >
            ...
            <path
              ...
              stroke="url(#paint3_linear_bottom)"
            />
            <circle
              opacity="0.8"
              cx="214.505"
              ...
              stroke="url(#paint4_linear_bottom)"
            />
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#FF520E" stopOpacity="0" />
                <stop offset="1" stopColor="#FF520E" />
              </linearGradient>
              <linearGradient
