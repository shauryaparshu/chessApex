    ...
    <section className="relative z-10 py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Join us at ChessApex to enhance your chess skills with expert guidance, engaging classes, and affordable pricing tailored for all levels."
          center
          mb="80px"
        />
          ...
          <div className="w-full px-4">
            ...
            >
              <div className="relative aspect-[77/40] items-center justify-center">
                <Image
                  src="/images/video/chessboard.jpg"
                  alt="video image"
                  fill
                />
